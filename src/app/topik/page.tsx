    ...
    <div className="space-y-10 pb-12">
      ...
      <div className="bg-gradient-to-r from-indigo-800 via-indigo-700 to-blue-800 text-white rounded-3xl p-8 sm:p-10 shadow-xl relative overflow-hidden">
        <div className="max-w-2xl space-y-3 relative z-10">
          ...
          <h1 className="text-3xl sm:text-4xl font-black">Senarai Topik Matematik / Math Topics</h1>
          <p className="text-slate-200 text-sm sm:text-base leading-relaxed">
            Pilih modul pembelajaran di bawah untuk meneroka konsep, animasi interaktif, dan kuiz kefahaman. / Select a learning module below to explore concepts, interactive animations, and quizzes.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-bold text-slate-800 dark:text-white flex items-center gap-2">
            ...
            <span>Topik Diterbitkan ({publishedTopics.length}) / Published Topics</span>
          </h2>
        </div>
        ...
        {publishedTopics.length === 0 ? (
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-12 text-center border border-slate-200 dark:border-slate-700">
            ...
            <h3 className="text-lg font-bold text-slate-700 dark:text-slate-200">Belum Ada Topik Diterbitkan / No Published Topics</h3>
              ...
              >
                <div className="space-y-4">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <span className="text-xs font-semibold text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/60 px-2.5 py-1 rounded-md border border-emerald-200 dark:border-emerald-800 flex items-center gap-1">
                      <CheckCircle className="w-3.5 h-3.5" /> Bersedia Belajar / Ready
                    </span>
                  </div>
                  ...
                  <div className="bg-slate-50 dark:bg-slate-900/50 rounded-xl p-3 border border-slate-100 dark:border-slate-700 text-xs text-slate-600 dark:text-slate-300 space-y-1">
                    <span className="font-bold text-slate-900 dark:text-white">Standard Pembelajaran / Learning Standard:</span>
                ...
                <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-700 flex items-center justify-between">
                  <span className="text-xs font-semibold text-slate-500 dark:text-slate-400">
                    {topic.sections?.length || 0} Bahagian Nota / Sections
                  </span>
                  <Link
