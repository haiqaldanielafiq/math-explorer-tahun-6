  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-slate-900">Papan Pemuka Pentadbir (Dashboard)</h1>
          <p className="text-slate-600 text-sm mt-1">
            Selamat datang, Cikgu! Urus modul, nota, aktiviti, dan kuiz Matematik Tahun 6 di sini.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-sm space-y-2">
          ...
          <div className="text-3xl font-black text-slate-900">{totalTopics}</div>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-sm space-y-2">
          ...
          <div className="text-3xl font-black text-emerald-600">{publishedTopics}</div>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-sm space-y-2">
          ...
          <div className="text-3xl font-black text-amber-600">{draftTopics}</div>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-sm space-y-2">
          ...
          <div className="text-3xl font-black text-blue-600">{totalActivities}</div>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-sm space-y-2">
          ...
          <div className="text-3xl font-black text-purple-600">{totalQuizQuestions}</div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl border border-slate-200/80 shadow-lg p-6 sm:p-8 space-y-6">
        <div className="flex items-center justify-between border-b border-slate-100 pb-4">
          <div>
            <h2 className="text-xl font-bold text-slate-900">Senarai Pengurusan Kandungan</h2>
            <p className="text-xs text-slate-500">Sunting kandungan, ubah status draf/terbitan atau lihat pratonton.</p>
          </div>
          <Link
            href="/admin/topik"
            ...
            <tbody className="divide-y divide-slate-100">
              {topics.map((t) => (
                <tr key={t.id} className="hover:bg-slate-50/80 transition-colors">
                  <td className="py-4 px-2 font-mono font-bold text-indigo-700">
                    {t.code}
                  </td>
                  <td className="py-4 px-2 font-bold text-slate-900">
                    {t.title}
                    <span className="block text-xs font-normal text-slate-500 line-clamp-1">{t.standardKandungan}</span>
                  </td>
